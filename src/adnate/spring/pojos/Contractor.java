...
public class Contractor {
	...
	public Contractor(int ctrId, String ctrName, String ctrNum, String ctrAddress, String ctrEmailId,
	...
	public String toString() {
		return "Contractor [ctrId=" + ctrId + ", ctrName=" + ctrName + ", ctrNum=" + ctrNum + ", ctrAddress="
				+ ctrAddress + ", ctrEmailId=" + ctrEmailId + ", organisationId=" + organisationId + "]";
	}
