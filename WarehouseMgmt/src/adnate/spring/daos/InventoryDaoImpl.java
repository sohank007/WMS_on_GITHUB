...
public class InventoryDaoImpl implements InventoryDao {
	...
	public void updateInventoryOnInward(InwardDetails inwardDetailsPOJO) {
		...
		Inward inwardObj = inwardDetailsPOJO.getInward();
		String orgId = inwardObj.getOrganisationId();
	...
	public void updateInventoryOnOutward(OrderDetails orderDetailsPOJO) {
		...
		Category categoryObj = orderDetailsPOJO.getMaterial().getCategory();
		System.out.println("catObj: " + categoryObj);
		
		Order orderObj = orderDetailsPOJO.getOrder();
		String orgId = orderObj.getOrganisationId();
		inventoryPOJO.setOrganisationId(orgId);
		...
		if (inventoryPOJO != null) {
			double inventory_availQty = inventoryPOJO.getAvailableQty();
			System.out.println("availQty: " + inventory_availQty);
/*			double inventory_totalQty = inventoryPOJO.getTotalQty();*/
	...
	public List<InventoryPOJO> getInventoryByOrgId(String organisationId) {
		System.out.println("inside getInventoryByOrgId() method");
		Session hbSession = sFactory.getCurrentSession();
		Query query = hbSession.createSQLQuery("select * from inventory_details where organisation_id=:organisationId")
				.addEntity(InventoryPOJO.class);
