        ...
        <md-input-container style="margin: 10px 10px 0px 5px;" flex="15">
         ...
         -->
          ...
          <input  ng-model="Order_id" type="text" >
                         ...
                         <md-input-container layout="row"  flex="40" style="margin: 5px 10px;">
               <md-button type="Submit" class="md-raised" style="margin:0px 10px;" 
               ng-click="generateO($event)">Create Order</md-button>
               <md-button type="Submit" class="md-raised" style="margin:0px 10px;" 
                ng-click="showData()" ng-hide="selectionItem.length==0">Generate Invoice </md-button>
                </md-input-container>
 ...
 <!--      <th ></th> -->
	  ...
	  ng-click="viewO($event,order.orderId)"> 
			...
			style="display:inline-block;"
			 ng-click="addToInvoice(order.orderId)" ng-disabled="order.orderMasterInvoiceStatus=='Invoiced'">
          </td>
