...
<h2 style="padding: 10px;">Add Contractor</h2></div>
     ...
     <div style="margin: 30px 10px 0px;" layout="column">
      ...
      <label style="font-weight: 100;">Contractor Name</label>
      ...
      <div ng-messages="AddContractorForm.ctrName.$error">
            ...
            <md-input-container style="margin:0px 10px;"> 
      <label style="font-weight: 100;">Contractor Address</label>
      ...
      <label style="font-weight: 100;">Contractor Number</label>
      ...
      <div ng-messages="AddContractorForm.ctrNum.$error">
          ...
          <md-input-container  style="margin:0px 10px;" flex="50">
            <label style="font-weight: 100;">Contractor Email Id</label>
...
<md-input-container style="margin:0px 10px;" >
            <md-button type="Submit" class="md-raised"  ng-click="add_contr()" 
