...
<thead>
  ...
  |orderBy:variable:reverse |itemsPerPage:10 ">
      <td style="text-align: left;width: 160px;">{{inventory.warehouse.warehouseName}}</td>
          <td style="text-align: left;width: 160px;">{{inventory.material.category.categoryName}}</td>
    <td style="text-align: left;width: 160px;">{{inventory.material.materialName}}</td>
    <td style="text-align: left;width: 250px;">{{inventory.material.unitOfMeasure}}</td>
...
<!--     <td>{{inventory.warehouse.warehouseName}}</td> -->
    <td style="text-align: right;width: 250px;">{{inventory.totalQty |number:2}}</td>
    <td style="text-align: right;width: 220px;">{{inventory.availableQty |number:2}}</td>
