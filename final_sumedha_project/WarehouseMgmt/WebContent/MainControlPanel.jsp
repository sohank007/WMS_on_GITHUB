        ...
        <!-- 	<md-button class="md-icon-button" aria-label="Settings" > -->
          <md-icon md-svg-icon="scripts/svgImgs/menu1.svg "
           ng-click="lockLeft=!lockLeft" hide-gt-sm style="margin: auto 0px;"></md-icon>
        	<!-- </md-button> --><!-- <span>  -->
          <a  >Warehouse Management System</a><!-- </span> -->
		</div>
    </md-toolbar>
...
<!--       <div style="float: left;background-color:#eeeeee;" flex> -->
      ...
      <!--    <md-content style="background-color:#104E8B;" flex> -->
			<md-list  ng-repeat="menu in rolemenus">
					 <md-list-item flex ng-click="setRoute(menu.menuName,$index)" ng-class="{selectedIndex: selectedIndex===$index}">
 					<md-icon md-svg-icon="{{menu.menuIcon}}" flex style="padding:0px;margin:0px;
 					max-width: 60px;"></md-icon>
