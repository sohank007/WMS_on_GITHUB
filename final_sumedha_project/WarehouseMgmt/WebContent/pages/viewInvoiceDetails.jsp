...
<div>
	...
	font-weight: bold; color: gray;">Bill To</label>&nbsp;&nbsp;&nbsp;&nbsp;	
		...
		<td></td>
		<td></td>
			<td><label style=";color: gray;">Invoice Date</label></td>
			<td>{{invoicemaster.invoiceDate | date:'dd/MM/yyyy'}}</td>
		</tr>
		<tr>
		<td></td>
		<td></td>
		<td></td>
			<td><label style="color: gray;">Due Date</label></td>
			<td>{{invoicemaster.validDate| date:'dd/MM/yyyy'}}</td>
		</tr>
		<tr>
			<td></td>
			<td></td>
	...
	<table class="invoiceDetClass">
		...
		<tbody>
			<tr ng-repeat="inv in data ">
				...
				<td>{{inv.material.unitPrice | number:2}}</td>
				<td>{{inv.quantity | number:2}}</td>
				<td>{{inv.totalAmount | number:2}}</td>
			</tr>
		</tbody>
	</table>
<br>
...
<!-- 		<tr ng-hide="taxes.length==0">
		...
		<a href="{{downloadlink}}" download="{{downloadlink}}">Download</a>
