...
<h2 style="padding: 10px;">Add Warehouse</h2></div>
      ...
      <form name="AddWarehouseForm" novalidate>
       ...
       <div style="margin: 30px 10px 0px;" layout="column">
            ...
            <label style="font-weight: 100;">Warehouse Name</label>
          ...
          <md-input-container style="margin:0px 10px;">
            <label style="font-weight: 100;">Warehouse Location</label>
            ...
            <div ng-message="md-maxlength">Warehouse location must be less than 100 characters long.</div>
          </div>
          </md-input-container>
