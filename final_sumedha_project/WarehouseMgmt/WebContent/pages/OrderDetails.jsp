...
<div style="margin: 0px 10px;    height: 50px;" layout="row" ng-hide="role=='CTR'">
<md-input-container style="margin:0px;">
<md-button type="Submit" class="md-raised" 
               ng-click="showData()" ng-disabled="disableButton" >Generate Invoice</md-button>
...
<!--            <th>Return Date</th> -->
      ...
      <tbody>
<tr dir-paginate="orderDet in orderDetail | filter:categoryName | filter:materialCode | itemsPerPage:2 " class="tr">        
...
<!--     <td>{{orderDet.order.orderId}}</td> -->
        ...
        <td style="text-align: left;">{{orderDet.material.materialName}}</td>
         <td style="text-align: left;">{{orderDet.material.materialCode}}</td>
