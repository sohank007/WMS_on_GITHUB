...
<!-- 						<md-list-item>
			  			...
			  			<md-list-item flex>
  							<a  ng-click="setRoute('inventoryDetails')" class="sidenavClass" ><md-icon md-svg-icon="scripts/svgImgs/inventory.svg" flex></md-icon>Inventory</a>
 						</md-list-item>
 						<md-list-item flex>
  							<a  ng-click="setRoute('ViewOrder')" class="sidenavClass"><md-icon md-svg-icon="scripts/svgImgs/order1.svg" flex></md-icon>Order</a>
 						</md-list-item>				
 						<md-list-item flex>
  							<a  ng-click="setRoute('viewInward')" class="sidenavClass"><md-icon md-svg-icon="scripts/svgImgs/inward.svg" flex></md-icon>Inward</a>
 						</md-list-item>
  						<md-list-item flex>
  							<a  ng-click="setRoute('materialDetails')" class="sidenavClass"><md-icon md-svg-icon="scripts/svgImgs/material.svg" flex></md-icon>Material</a>
 						</md-list-item>	
 						<md-list-item flex>
  							<a  ng-click="setRoute('warehouseDetails')" class="sidenavClass"><md-icon md-svg-icon="scripts/svgImgs/warehouse.svg" flex></md-icon>Warehouse</a>
 						</md-list-item>
 						<md-list-item flex>
  							<a  ng-click="setRoute('contractorDetails')" class="sidenavClass"><md-icon md-svg-icon="scripts/svgImgs/contractor.svg" flex></md-icon>Contractor</a>
 						</md-list-item>
 						<md-list-item flex>
  							<a  ng-click="setRoute('viewInvoice')" class="sidenavClass"><md-icon md-svg-icon="scripts/svgImgs/contractor.svg" flex></md-icon>invoice</a>
 						</md-list-item>
